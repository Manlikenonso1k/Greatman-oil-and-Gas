...
<head>
    ...
    <title>Server Error | GreatMan Oil & Gas</title>
...
<body class="bg-surface">
    <div class="min-h-screen flex items-center justify-center px-lg py-xxl">
        <div class="text-center max-w-md">
            ...
            <h1 class="text-6xl font-bold text-primary mb-md">500</h1>
            <h2 class="text-2xl font-bold text-on-surface mb-sm">Server Error</h2>
            <p class="text-on-surface-variant mb-xl">Something went wrong on our end. Our team has been notified and is working on it.</p>
