...
<div class="fixed bottom-lg right-lg z-40 flex flex-col gap-md">
    ...
    <a href="https://maps.app.goo.gl/PCdCpqD6PbYgangX8" target="_blank" rel="noopener noreferrer" class="bg-primary text-on-primary h-14 w-14 rounded-full shadow-lg flex items-center justify-center hover:scale-110 active:scale-95 transition-transform">
